...
// return ["x"*IntegerToString((i+1)*(j+1)): i in [0..n-1],j in [0..r-1]];
// end intrinsic;
...
// return ["x"*IntegerToString((i+1)*(j+1)):
...
return ["x"*IntegerToString((i+1)*(j+1)):
//["d(i"*IntegerToString(i)*",j"*IntegerToString(j)*")":
