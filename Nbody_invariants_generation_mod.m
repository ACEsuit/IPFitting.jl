...
//Outputfile name
outputfile := "Nbody_" cat IntegerToString(nbody) cat "_degree_" cat IntegerToString(deg) cat ".txt";
//Logfile name
logfile := "logNbody_" cat IntegerToString(nbody) cat "_degree_" cat IntegerToString(deg) cat ".txt";
